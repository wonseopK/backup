	...
	<section class="ftco-section ftco-no-pb">
		<div class="container" style="font-family: 'Noto Sans KR:wght@400', sans-serif;">
			<div class="row">
				...
				<div class="col-lg-2 col-md-4 ">
					<div class="sort w-100 text-center ftco-animate">
						<div class="img" style="background-image: url(images/car2.jpg);"></div>
						<h3>현대 팰리세이드</h3>
					</div>
				</div>
				<div class="col-lg-2 col-md-4 ">
					<div class="sort w-100 text-center ftco-animate">
						<div class="img" style="background-image: url(images/car3.jpg);"></div>
						<h3>기아 K8</h3>
					</div>
				</div>
				<div class="col-lg-2 col-md-4 ">
					<div class="sort w-100 text-center ftco-animate">
						<div class="img" style="background-image: url(images/car4.jpg);"></div>
						<h3>쉐보레 스파크</h3>
					</div>
				</div>
				<div class="col-lg-2 col-md-4 ">
					<div class="sort w-100 text-center ftco-animate">
						<div class="img" style="background-image: url(images/car5.jpg);"></div>
						<h3>르노삼성 XM3</h3>
					</div>
				</div>
				<div class="col-lg-2 col-md-4 ">
					<div class="sort w-100 text-center ftco-animate">
						<div class="img" style="background-image: url(images/car6.png);"></div>
						<h3>현대 그랜저</h3>
					</div>
				</div>
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 d-flex">
					<div class="product ftco-animate">
						...
						<div class="text text-center">
							<span class="sale">Sale</span> <span class="category">Car1</span>
							<h2>Car1 차종</h2>
							<p class="mb-0">
								<span class="price price-sale">$369.00</span> <span class="price">$449.00</span>
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-3 d-flex">
					<div class="product ftco-animate">
						...
						<div class="text text-center">
							<span class="seller">Best Seller</span> <span class="category">Car2</span>
							<h2>Car2 차종</h2>
				...
				<div class="col-md-3 d-flex">
					<div class="product ftco-animate">
						...
						<div class="text text-center">
							<span class="new">New Arrival</span> <span class="category">Car3</span>
							<h2>Car3 차종</h2>
			...
			<div class="row justify-content-center">
				<div class="col-md-4">
					<a href="product.jsp" class="btn btn-primary d-block">View All
					...
					<div class="carousel-testimony owl-carousel ftco-owl" style="font-family: 'Noto Sans KR:wght@100', sans-serif;">
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">자동차를 타는 즐거움이 너무 커졌습니다.</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">k-car 덕분에 매일 매일 즐거운 하루!!</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">너무 즐거웠습니다 감사합니다.</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
											style="background-image: url(images/person_1.jpg)"></div>
										<div class="pl-3">
						...
						<div class="item">
							<div class="testimony-wrap py-4">
								...
								<div class="text">
									<p class="mb-4">안전을 생각하면 k-car가 정답입니다.</p>
									<div class="d-flex align-items-center">
										<div class="user-img"
											style="background-image: url(images/person_2.jpg)"></div>
										<div class="pl-3">
